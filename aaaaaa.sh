...
function launch_provider () {
  ...
  export YAGNA_API_URL=http://0.0.0.0:$((_YAGNA_API_PORT_BASE+i))
  export GSB_URL=tcp://127.0.0.1:$((_GSB_PORT_BASE+i))
  export NODE_NAME=${node_name}
  export YA_NET_BIND_URL=udp://0.0.0.0:$((_NET_PORT_BASE+i))
  export YAGNA_DATADIR=${_YAGNA_DATADIR_BASE}${node_name}
  export DATA_DIR=${_DATA_DIR_BASE}${node_name}
